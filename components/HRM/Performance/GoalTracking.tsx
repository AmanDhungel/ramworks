...
const PERFORMANCE_DATA = [
  ...
  },
  {
    ...
    endDate: "22 Jan 2024",
    description: "Develop a website for a client",
    status: "Active",
    progress: 70,
  },
  {
    ...
    endDate: "19 Feb 2024",
    description: "Develop a mobile app for a client",
    status: "Active",
    progress: 50,
  },
  {
  ...
  return (
    <div className="p-6 bg-[#F8F9FA] min-h-screen font-sans">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Goal Tracking</h1>
          <p className="text-sm text-slate-500 flex items-center gap-1 mt-1">
            🏠 / Performance /{" "}
            <span className="text-slate-900 font-medium">Goal Tracking</span>
          </p>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {PERFORMANCE_DATA.map((item) => (
                  <tr
                    ...
                    <td className="flex flex-col px-4 py-4 text-slate-500 font-medium">
                      Complete{" "}
                      <span>
                        {" "}
